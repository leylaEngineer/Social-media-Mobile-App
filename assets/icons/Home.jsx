...
const Home = (props) => (
    ...
    <Svg xmlns="http://www.w3.org/2000/svg" viewBow="0 0 24 24" width={24} height={24} color="#000000" fill="none" {...props}>
    <Path d="M15.0001 17C14 17.6224 13.1504 18 12.0001 18C10.8499 18 9.79965 17.6224 9.00012 17" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
